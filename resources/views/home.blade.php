    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="max-w-2xl text-white">
            ...
            <div class="flex gap-4">
                <a href="{{ route('shop') }}" class="bg-green-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-green-600 transition-all transform hover:scale-105 shadow-xl shadow-green-500/20">Shop Now</a>
...
<section class="py-24 bg-white dark:bg-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="{{ route('shop') }}" class="text-green-500 font-bold hover:text-green-600">View All Categories →</a>
        </div>
                    ...
                    <div class="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-700 mb-4 shadow-sm group-hover:shadow-xl transition-all">
                        ...
                        @else
                            <div class="w-full h-full flex items-center justify-center">
                                <span class="text-4xl font-bold text-gray-300">{{ substr($category->name, 0, 1) }}</span>
                            </div>
                        @endif
                    </div>
                    <h3 class="font-bold group-hover:text-green-500 transition-colors">{{ $category->name }}</h3>
                </a>
            @endforeach
        </div>
    </div>
