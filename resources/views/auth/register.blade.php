...
<div class="bg-white dark:bg-gray-800 rounded-[2rem] p-8 shadow-xl border border-gray-100 dark:border-gray-700">
    <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white text-center mb-2">Create your account</h2>
    <p class="text-sm text-gray-600 dark:text-gray-400 text-center mb-8">
        Already have an account? <a href="{{ route('login') }}" class="font-medium text-green-500 hover:text-green-600">Sign in</a>
    </p>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div>
            <label for="name" class="block text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Full Name</label>
        ...
        <div class="flex items-start">
            <input id="terms" type="checkbox" required class="rounded text-green-500 focus:ring-green-500 mt-1">
            <label for="terms" class="ml-2 text-sm text-gray-600 dark:text-gray-400">
                I agree to the <a href="#" class="text-green-500 hover:text-green-600">Terms of Service</a> and <a href="#" class="text-green-500 hover:text-green-600">Privacy Policy</a>
            </label>
        </div>
    ...
    <div class="mt-8">
        ...
        <div class="mt-6 grid grid-cols-1 gap-3">
            <a href="{{ route('auth.google') }}" class="w-full inline-flex justify-center items-center gap-2 bg-white dark:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-xl px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all">
